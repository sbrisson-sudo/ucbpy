...
/*-----------------------------------------------
              @(target):= _pyspl_driver.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__pyspl_driver

#else
#  define SWIG_init    init_pyspl_driver

#endif
#define SWIG_name    "_pyspl_driver"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap__bspl_driver(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "_bspl_driver", 5, 5, swig_obj)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(swig_obj[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "_bspl_driver" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
  {
    npy_intp size[1] = {
  ...
  if (!SWIG_IsOK(ecode6)) {
    SWIG_exception_fail(SWIG_ArgError(ecode6), "in method '" "_bspl_driver" "', argument " "6"" of type '" "int""'");
  } 
  arg6 = (int)(val6);
  {
  ...
  result = (int)_bspl_driver(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8);
...
SWIGINTERN PyObject *_wrap__sspl_driver(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int arg1 ;
  double *arg2 = (double *) 0 ;
  int arg3 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "_sspl_driver", 9, 9, swig_obj)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(swig_obj[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "_sspl_driver" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
  {
    npy_intp size[1] = {
  ...
  }
  {
    ...
    array10 = obj_to_array_contiguous_allow_conversion(swig_obj[5],
      NPY_DOUBLE,
      &is_new_object10);
  ...
  {
    array12 = obj_to_array_no_conversion(swig_obj[6], NPY_DOUBLE);
  ...
  {
    array14 = obj_to_array_no_conversion(swig_obj[7], NPY_INT);
  ...
  {
    array16 = obj_to_array_no_conversion(swig_obj[8], NPY_INT);
  ...
  result = (int)_sspl_driver(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11,arg12,arg13,arg14,arg15,arg16,arg17);
  resultobj = SWIG_From_int((int)(result));
  {
    if (is_new_object2 && array2)
    {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "_bspl_driver", _wrap__bspl_driver, METH_VARARGS, NULL},
	 { "_sspl_driver", _wrap__sspl_driver, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
